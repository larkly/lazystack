...
func (m Model) Update(msg tea.Msg) (Model, tea.Cmd) {
	...
	case memberCreatedMsg:
		...
		return m, func() tea.Msg {
			return shared.ResourceActionMsg{Action: "Added member to", Name: m.poolName}
		}
...
func (m Model) handleKey(msg tea.KeyMsg) (Model, tea.Cmd) {
	// All fields except submit/cancel are text inputs
	if m.focusField <= fieldWeight {
		switch {
...
func (m Model) View() string {
	title := shared.StyleModalTitle.Render("Add Member to " + m.poolName)
